...
import com.jmateos.mateos_javier_aplicacioninmo.PropertiesFragment.OnListFragmentInteractionListener;
...
public class PropertiesRecyclerViewAdapter extends RecyclerView.Adapter<PropertiesRecyclerViewAdapter.ViewHolder> {
    ...
    public PropertiesRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
